...
const Home = () => {
    return (
        <div className={styles.homeRoot}>
            ...
            <GorizontalSeporator type='line' size='md' color='var(--gray-400)' />
            <h3>Дисклеймер:</h3>
            <GorizontalSeporator type='space' size='xs' />
            <p>
                <b>"ЧИХ"</b> (обиходное название данной платформы) сейчас в активной разработке,
            ...
            <p className={styles.p}>
                ...
                профиль, журнал, <b>страница c инструкцией</b>, а так же оттуда можно выйти из своего профиля.
